...
document.getElementById("submitSignUp")?.addEventListener("click", async (e) => {
  ...
  try {
    ...
    hideLoadingToast();
    showCustomToast("🎉 Account Created Successfully!", "track.html");
  } catch (error) {
    hideLoadingToast();
    const errorMsg =
...
document.getElementById("submitSignIn")?.addEventListener("click", async (e) => {
  ...
  try {
    ...
    hideLoadingToast();
    showCustomToast("✅ Welcome back!", "homepage.html");
  } catch (error) {
    hideLoadingToast();
...
document.getElementById("googleSignIn")?.addEventListener("click", async () => {
  ...
  try {
    ...
    hideLoadingToast();
    showCustomToast(`✅ Welcome, ${user.displayName}`, "homepage.html");
  } catch (error) {
    hideLoadingToast();
